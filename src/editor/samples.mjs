...
export const SAMPLES = [
  { id: "hello", title: "Hello world", note: "input, button, binding", source: HELLO },
  { id: "counter", title: "Counter", note: "state across roundtrips", source: COUNTER },
  { id: "table", title: "Table with selection", note: "internal table, row template", source: TABLE },
  { id: "form", title: "Form and validation", note: "message box, layout library", source: FORM },
  { id: "tabs", title: "Tabs and a list", note: "event arguments, growing table", source: TABS },
  { id: "popup", title: "Confirmation popup", note: "nav_app_call, on-navigated", source: POPUP },
];

export const DEFAULT_SAMPLE = SAMPLES[0];
export const DEFAULT_SOURCE = DEFAULT_SAMPLE.source;
